...
INSERT INTO lots (creation_date, lot_name, image, start_price, exp_date, creator_id, category_id)
VALUES
	('2021-09-27 00:00', '2014 Rossignol District Snowboard', 'img/lot-1.jpg', 10999, '2021-10-10 00:00', 1, 1),
	('2021-09-27 03:00', 'DC Ply Mens 2016/2017 Snowboard', 'img/lot-2.jpg', 159999, '2021-10-11 00:00', 1, 1),
	('2021-09-26 00:00', 'Крепления Union Contact Pro 2015 года размер L/XL', 'img/lot-3.jpg', 8000, '2021-10-12 15:00', 2, 2),
	('2021-09-25 00:00', 'Ботинки для сноуборда DC Mutiny Charocal', 'img/lot-4.jpg', 10999, '2021-10-13 00:00', 1, 3),
	('2021-09-24 20:00', 'Куртка для сноуборда DC Mutiny Charocal', 'img/lot-5.jpg', 7500, '2021-10-14 10:00', 2, 4),
	('2021-09-24 17:00', 'Маска Oakley Canopy', 'img/lot-6.jpg', 5400, '2021-10-14 18:00', 2, 6);

CREATE INDEX id ON lots(id); # Для поиска лота по идентификатору
